...
function echars0(imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreData?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreData?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryRiskeAssessment?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
...
function talkDown(year){
    $("#talkDown").one("click",function(){
        $.ajax({
            type: "get",
            url: "http://" + host + "/industryRiskExport/exportIndustryRiskeAssessment?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
            data:{"date":year},
            dataType: "json",
            async: true,
            success: function (data) {
...
function startPhoto(indexArr,imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7&periods=12",
...
function timeChange(indexArr,imIdArr,year){
    ...
    $("#indexOneTab li a").one("click",function(event) {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
...
function search(indexList){
    ...
    $("#senameSeach").click(function () {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryList?xjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
            data: {
...
function monitorTable(datas){
    ...
    $("#mointerBody tr td:nth-child(3)").click(function(){
        ...
        //给下一页传参
        window.location.href="cycleSpecificData.html?seId="+seId+"&nowName="+nowName;
    });
