    ...
    function (ec) {
        ...
        option = {
            ...
            dataRange: {
                ...
                y: '320px',
                splitList: [
                    {start: 50,label:'>=50%', color: 'blue'},
                    {start: 30, end: 50,label:'30-50%', color: 'yellow'},
                    {start: 10, end: 30,label:'10-30%', color: 'red'},
                    {start: 5, end: 10, label: '5-10%', color: 'orange'},
                    {start: 1, end: 5, label: '1-5%', color: 'pink'},
                    {end: 1,label:'<1%', color: 'black'}
                ],
                // color: ['orange', 'yellow'],
                calculable: false
            },
