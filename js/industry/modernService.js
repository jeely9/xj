...
function echars0(imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreData?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreData?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryRiskeAssessment?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
        // url:"http://192.168.3.4:8081/industry/getIndustryRiskeAssessment?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
        data:{"imIdArr":imIdArr,"date":year},
        async: true,
        success: function (data) {
            var datas = data.val;
...
function talkDown(year){
    $("#talkDown").one("click",function(){
        $.ajax({
            type: "get",
            url: "http://" + host + "/industryRiskExport/exportIndustryRiskeAssessment?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
            data:{"date":year},
            dataType: "json",
            async: true,
            success: function (data) {
...
function startPhoto(indexArr,imIdArr,year){
    ...
    if(indexArr== null){
        indexArr="营业收入(销售额)累计增长(%)";
    }
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A&periods=12",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A&periods=12",
...
function timeChange(indexArr,imIdArr,year){
    ...
    $("#indexOneTab li a").one("click",function(event) {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
            // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
...
function search(indexList){
    ...
    $("#senameSeach").click(function () {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryList?xjCategoryName=%E7%8E%B0%E4%BB%A3%E6%9C%8D%E5%8A%A1%E4%B8%9A",
            data: {
...
function monitorTable(datas){
    ...
    $("#mointerBody tr td:nth-child(3)").click(function(){
        ...
        //给下一页传参
        window.location.href="modernSpecificData.html?seId="+seId+"&nowName="+nowName;
    });
