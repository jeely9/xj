...
function echars0(imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreData?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreData?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9",
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryRiskeAssessment?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9",
        // url:"http://192.168.3.4:8081/industry/getIndustryRiskeAssessment?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
        data:{"imIdArr":imIdArr,"date":year},
        async: true,
        success: function (data) {
            var datas = data.val;
...
function talkDown(year){
    $("#talkDown").one("click",function(){
        $.ajax({
            type: "get",
            url: "http://" + host + "/industryRiskExport/exportIndustryRiskeAssessment?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9",
            data:{"date":year},
            dataType: "json",
            async: true,
            success: function (data) {
...
function startPhoto(indexArr,imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9&periods=12",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9&periods=12",
        data:{"indexArr":indexArr,"imIdArr":imIdArr},
        async: true,
        success: function (data) {
            var datas = data.val;
            // console.log(datas);
...
function indexChange(indexArr,imIdArr,year){
    ...
    $("#priceQuarter").one("change",function(){
        var indexList = $("#priceQuarter option:selected").html();
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9&periods=12",
            // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7&periods=12",
            data:{
                "indexArr":indexList,
                "imIdArr":imIdArr,
                "date":year
...
function timeChange(indexArr,imIdArr,year){
    ...
    $("#indexOneTab li a").one("click",function(event) {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9",
            // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%91%A8%E6%9C%9F%E6%80%A7",
...
function search(indexList){
    ...
    $("#senameSeach").click(function () {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryList?xjCategoryName=%E5%A4%A7%E6%B6%88%E8%B4%B9",
            data: {
...
function monitorTable(datas){
    ...
    $("#mointerBody tr td:nth-child(3)").click(function(){
        ...
        //给下一页传参
        window.location.href="bigSpecificData.html?seId="+seId+"&nowName="+nowName;
    });
