...
function echars0(imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreData?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreData?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryRiskeAssessment?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
        // url:"http://192.168.3.4:8081/industry/getIndustryRiskeAssessment?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
        data:{"imIdArr":imIdArr,"date":year},
        async: true,
        success: function (data) {
            var datas = data.val;
...
function talkDown(year){
    $("#talkDown").one("click",function(){
        $.ajax({
            type: "get",
            url: "http://" + host + "/industryRiskExport/exportIndustryRiskeAssessment?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
            data:{"date":year},
            dataType: "json",
            async: true,
            success: function (data) {
...
function startPhoto(indexArr,imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81&periods=12",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81&periods=12",
...
function timeChange(indexArr,imIdArr,year){
    ...
    $("#indexOneTab li a").one("click",function(event) {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
            // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
...
function search(indexList){
    ...
    $("#senameSeach").click(function () {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryList?xjCategoryName=%E5%85%AC%E5%85%B1%E5%93%81",
            data: {
...
function monitorTable(datas){
    ...
    $("#mointerBody tr td:nth-child(3)").click(function(){
        ...
        //给下一页传参
        window.location.href="publicSpecificData.html?seId="+seId+"&nowName="+nowName;
    });
