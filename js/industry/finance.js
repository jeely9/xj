...
function echars0(imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreData?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreData?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryRiskeAssessment?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
        // url:"http://192.168.3.4:8081/industry/getIndustryRiskeAssessment?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
        data:{"imIdArr":imIdArr,"date":year},
        async: true,
        success: function (data) {
            var datas = data.val;
...
function talkDown(year){
    $("#talkDown").one("click",function(){
        $.ajax({
            type: "get",
            url: "http://" + host + "/industryRiskExport/exportIndustryRiskeAssessment?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
            data:{"date":year},
            dataType: "json",
            async: true,
            success: function (data) {
...
function startPhoto(indexArr,imIdArr,year){
    ...
    $.ajax({
        type: "get",
        url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93&periods=12",
        // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93&periods=12",
...
function timeChange(indexArr,imIdArr,year){
    ...
    $("#indexOneTab li a").one("click",function(event) {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryCoreDataImage?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
            // url:"http://192.168.3.4:8081/industry/getIndustryCoreDataImage?imXjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
...
function search(indexList){
    ...
    $("#senameSeach").click(function () {
        ...
        $.ajax({
            type: "get",
            url: "http://" + host + "/industry/getIndustryList?xjCategoryName=%E9%87%91%E8%9E%8D%E8%B4%B8%E6%98%93",
            data: {
...
function monitorTable(datas){
    ...
    $("#mointerBody tr td:nth-child(3)").click(function(){
        ...
        //给下一页传参
        window.location.href="financeSpecificData.html?seId="+seId+"&nowName="+nowName;
    });
