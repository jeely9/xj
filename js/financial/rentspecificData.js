...
var resizeCss = function() {
    ...
    $("#bussOnepie").css("width", width).css("height", height1);
    $("#bussTwopie").css("width", width).css("height", height1);
...
var bussOnepie = echarts.init(document.getElementById('bussOnepie'));
var bussTwopie = echarts.init(document.getElementById('bussTwopie'));
var option = option1 = option1 = option3 = option7 = option8 =null;
option = option1 = option2 = option3 = option7 =option8 ={
    title : {
        //text: '出资占比',
        //subtext: '纯属虚构',
        x:'center'
...
bussOnepie.setOption(option7,true);
bussTwopie.setOption(option8,true);
//Echars自适应浏览器大小
...
function businessEchars(list1,list4){
    var bussEpie1name = [];
    var bussEpie2name = [];
    var bussEpie1value = [];
    var bussEpie2value = [];
    ...
    for (var i =0;i<list1.length-1;i++){
        bussEpie1name.push(list1[i].name);
        bussEpie1value.push(list1[i].value[1]);
        bussEpie1data.push({name:list1[i].name,value:(list1[i].value[0]).replace(/,/g, "")});
    }
    businessEpie1(bussEpie1data);
    for (var m =0;m< list4.length;m++){
        bussEpie2name.push(list4[m].name);
        bussEpie2value.push(list4[m].value[1]);
        bussEpie2data.push({name:list4[m].name,value:(list4[m].value[0]).replace(/,/g, "")});
    }
...
function businessYear(seId,year){
    bussOnepie.showLoading();
    bussTwopie.showLoading();
    $.ajax({
        type:"get",
        ...
        success: function(data){
            bussOnepie.hideLoading();
            bussTwopie.hideLoading();
            var datas = data.val.val;
            // console.log(datas);
            $("#title1").html(datas[0].title);
            $("#title2").html(datas[1].title);
            $("#title3").html(datas[3].title);
            $("#title4").html(datas[2].title);
...
function businessTable(datas){
    ...
    var list3 = datas[3].list;
    var list4 = datas[2].list;
...
function totalList(seId,year){
    $.ajax({
        ...
        success: function(data){
            ...
            supUnit(list1,list2,list3);
        }
    })

}
function supUnit(list1,list2,list3){
    $("#supervisionUnit").change(function(){
        var unit = $("#supervisionUnit option:selected").text();
        if(unit=="元"){
            lists(list1,list2,list3);
        }else if(unit=="万元"){
            listsHundred(list1,list2,list3);
        }else{
            listsMillion(list1,list2,list3);
        }
    })
}
function lists(list1,list2,list3){
    var listcontent="";
    var listcontent1="";
    var listcontent2="";
...
function listsHundred(list1,list2,list3){
    var listcontent="";
    var listcontent1="";
    var listcontent2="";
    var reg=/%+/;
...
function listsMillion(list1,list2,list3){
    var listcontent="";
    var listcontent1="";
    var listcontent2="";
    var reg=/%+/;
